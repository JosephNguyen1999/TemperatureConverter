 ...
 *
 * Purpose: This program converts a temperature from Fahrenheit to Kelvin, Rankine, Reaumur, or Celsius.
 *
	...
	public static void main(String[] args) {
		...
		if (tempScale < 1 || tempScale > 4) {  // Second-if statement: Set a breakpoint here
			...
			if (tempScale == 1) { // Set a breakpoint here
				...
				convertedDegrees = ((fahrenheit - 32.0) * (4.0/9.0)); // Set a breakpoint here
